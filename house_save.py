...
def energyTrade(n, s, mutex, c, p, msg_queue, k):
    while(True):
        time.sleep(1)
        with mutex:
            if s[0]>n and c>p:
...
if __name__ == "__main__":
    ...
    # initialProdRate = 3 # 1 bar in 3 sec
    # initialConsRate = 10 # 1 bar in 10 sec
    ...
    trade = Thread(target=energyTrade, args=(energyNeeds, energyStock, lock, initialConsRate, initialProdRate, mq, key,))
